...
export default function NewsBlock() {
  return (
    <div className="relative bg-gray-50 pt-16 pb-20 px-2 sm:px-6 lg:pt-10 lg:pb-28 lg:px-8">
      <div className="absolute inset-0">
        <div className="bg-white h-1/3 sm:h-2/3" />
      </div>
      <div className="relative max-w-7xl mx-auto">
        <div className="text-left">
          <h2 className="text-3xl tracking-tight font-bold text-gray-900 sm:text-4xl">News</h2>
        </div>
